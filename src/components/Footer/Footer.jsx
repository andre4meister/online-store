  ...
  return (
    <div className={styles.about}>
      ...
      <div className={styles.about__menu}>
        <div className={styles.about__block_title}>Допомога</div>
        <div className={styles.menu_items}>
          <Link to="contacts" className={styles.menu_item}>
            Контакти
          </Link>
          <Link to="delivery" className={styles.menu_item}>
            Оплата і доставка
          </Link>
          <Link to="returning" className={styles.menu_item}>
            Повернення
          </Link>
          <Link to="sizes" className={styles.menu_item}>
            Таблиця розмірів
          </Link>
        </div>
      </div>
      <div className={styles.about__politics}>
        <div className={styles.about__block_title}>Умови</div>
        <div className={styles.menu_items}>
          <Link to="contacts" className={styles.menu_item}>
            Політика конфіденційності
          </Link>
          <Link to="delivery" className={styles.menu_item}>
            Політика щодо файлів кукі
          </Link>
        </div>
      </div>
