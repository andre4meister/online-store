...
const ItemPage = ({item}) => {
    const {id, name, photos, description, price, discountPrice, isAvailable} = item;
            ...
            <div className={styles.item}>
                <div className={styles.item__main}>
                    ...
                    <div className={styles.item__main__info}>
                        ...
                        <div className={styles.info__color}>
                            <span>Колір</span>
                            <div className={styles.info__color__block}>
                            </div>
                        </div>
                ...
                <div className={styles.item__description}>
                    <div className={styles.item__description__block}>
                        <h3>Опис</h3>
                        <p>Оверсайз футболка від бренду Ligo. Стильна футболка, яка відрізняється від звичайної більшим
                            розміром та забезпечує комфорт. Футболка виготовлена зі високоякісних матеріалів, які не
                            будуть дратувати шкіру та забезпечать довговічність.
                        </p>
                    </div>
                    <div className={styles.item__description__block}>
                        <h3>Склад</h3>
